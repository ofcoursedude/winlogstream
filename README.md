# winlogstream [![Go](https://github.com/ofcoursedude/winlogstream/actions/workflows/go.yml/badge.svg)](https://github.com/ofcoursedude/winlogstream/actions/workflows/go.yml)
